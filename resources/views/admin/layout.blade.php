...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dasboard">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item {{request()->is('admin/contactperson') ? 'active': ''}}">
                <a class="nav-link" href="/admin/contactperson">
                    <i class="fas fa-fw fa-table"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> Fadillah Emilia Nst </span>
    ...
    <script src="{{ asset('js/demochart-area-demo.js') }}"></script>
